Import-Module $PSScriptRoot\..\..\PSWinDocumentation.AD -Force
...
Documentimo -FilePath "$PSScriptRoot\Output\Starter-AD.docx" {
    ...
    DocNumbering -Text 'General Information - Forest Summary' -Level 0 -Type Numbered -Heading Heading1 {
        DocText {
            "Active Directory at $CompanyName has a forest name $($DataSetForest.ForestInformation.Name). Following table contains forest summary with important information:"
        }
            ...
            DocNumbering -Text 'Domain Password Quality' -Level 1 -Type Numbered -Heading Heading1 {
                ...
                DocNumbering -Text 'Password Quality - AES Keys Missing' -Level 2 -Type Numbered -Heading Heading2 {
                    ...
                    if ($DataSetForest.FoundDomains.$Domain.DomainPasswordAESKeysMissing) {
                        ...
                        DocText {
                            'There are no accounts that have their Kerberos AES keys missing.'
                        }
                    }
                }
